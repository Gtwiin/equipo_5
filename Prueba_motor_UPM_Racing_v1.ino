...
void loop()
{
  ...
  digitalWrite(7, LOW);
  analogWrite(5,80); /*Pongo como salida analógica la velocidad por el pin 5 Cuidado al subirlo por encima de 150 porque podría estar pasando de los 7V del motor*/
